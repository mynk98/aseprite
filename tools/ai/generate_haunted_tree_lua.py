#!/usr/bin/env python3
"""
Converts the Gnarled Haunted Elder Tree into a native Aseprite Lua script
...
import numpy as np
from render_haunted_tree import draw_haunted_tree

def generate_lua():
    layers, composite = draw_haunted_tree()
    output_lua = Path("/Users/mynk/Projects/aseprite/tools/ai/scripts/draw_haunted_tree.lua")
    user_scripts_lua = Path.home() / "Library/Application Support/Aseprite/scripts/draw_haunted_tree.lua"
    ...
    with open(output_lua, "w") as f:
        f.write("""-- Lyra Gnarled Haunted Elder Tree Painter
-- Programmatically draws a highly detailed 256x256 gothic game asset across 8 organized layers.
...
app.transaction("Draw Haunted Elder Tree by Lyra", function()
...
if not app.isUIAvailable then
  spr:saveAs("/Users/mynk/Desktop/drawn_haunted_tree.aseprite")
  spr:saveCopyAs("/Users/mynk/Desktop/haunted_tree_256.png")
end

print("Lyra: Gnarled Haunted Elder Tree drawn across 8 layers on 256x256 canvas successfully!")
""")
