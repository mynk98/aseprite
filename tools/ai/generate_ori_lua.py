#!/usr/bin/env python3
"""
Converts the Ori spirit character into a native Aseprite Lua script
...
import numpy as np
from render_ori_character import draw_ori

def generate_lua():
    layers, composite = draw_ori()
    output_lua = Path("/Users/mynk/Projects/aseprite/tools/ai/scripts/draw_ori_character.lua")
    user_scripts_lua = Path.home() / "Library/Application Support/Aseprite/scripts/draw_ori_character.lua"

    with open(output_lua, "w") as f:
        f.write("""-- Lyra Ori Spirit Guardian Painter
-- Programmatically draws an ethereal 2D platformer spirit character across 8 organized layers.
...
app.transaction("Draw Ori Spirit by Lyra", function()
...
if not app.isUIAvailable then
  spr:saveAs("/Users/mynk/Desktop/drawn_ori_character.aseprite")
end

print("Lyra: Ori Spirit Character drawn across 8 layers on 500x500 canvas successfully!")
""")
